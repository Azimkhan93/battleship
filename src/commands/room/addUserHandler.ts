import {  InMessageObject, OutCreateGameDataObject, OutCreateGameObject, OutUpdRoomDataObject } from '../../utilities/types';
...
const outCreateGameObject:  OutCreateGameObject= { type: 'create_game', data: outCreateGameDataJSON, id: 0 };
